  ...
  return (
    <div className="onboarding-banner" role="note">
      <p>
        ...
        drawing a real ground-track weave as Earth rotates underneath each orbit. Set a location in the dock to
        see exactly when it'll next be bright enough to spot overhead — computed from real orbital mechanics
        and solar geometry, not a guess.
      </p>
